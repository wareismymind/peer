...
namespace Peer.UnitTests
{
    public class PullRequestTests
    {
        public class Construct
        {
            ...
            {
                Assert.Throws<ArgumentNullException>(() => new PullRequest(null, _url, _descriptor, _state, _gitInfo));
            }
            ...
            {
                Assert.Throws<ArgumentNullException>(() => new PullRequest(_id, null, _descriptor, _state, _gitInfo));
            }

            [Fact]
            public void DescriptorNull_Throws()
            {
                Assert.Throws<ArgumentNullException>(() => new PullRequest(_id, _url, null, _state, _gitInfo));
            }

            [Fact]
            public void StateNull_Throws()
            {
                Assert.Throws<ArgumentNullException>(() => new PullRequest(_id, _url, _descriptor, null, _gitInfo));
            }

            [Fact]
            public void GitInfoNull_Throws()
            {
                Assert.Throws<ArgumentNullException>(() => new PullRequest(_id, _url, _descriptor, _state, null));
            }

            [Fact]
            public void ArgsValid_Constructs()
            {
                _ = new PullRequest(_id, _url, _descriptor, _state, _gitInfo);
            }
        }
    }
}
